      ...
      <section id="pricing" className="pls-pricing-section">
        <div className="pls-container">
          <div className="pls-section-header pls-animate">
            ...
            <p>No Hidden Fees. No Commissions. You keep 100% of your sales.</p>
          </div>
          <div className="pls-pricing-grid">
            {[
              {
                name: 'FREE', desc: 'Start Selling', amount: 'KES 0', period: '/month', popular: false,
                features: ['10 verified orders/month', 'Unlimited payment links', '1 basic store', 'Payment verification', 'Order tracking', 'Email support'],
                cta: 'Start Free', ctaStyle: 'pls-btn-secondary'
              },
              {
                name: 'BASIC', desc: 'For Growing Sellers', amount: 'KES 500', period: '/month', popular: true,
                features: ['UNLIMITED verified orders', 'Unlimited payment links', '1 professional store', 'Custom URL', 'SMS notifications', 'Priority support', 'Analytics dashboard'],
                cta: 'Start Free Trial', ctaStyle: 'pls-btn-primary'
              },
              {
                name: 'PREMIUM', desc: 'For Serious Business', amount: 'KES 2,000', period: '/month', popular: false,
                features: ['Everything in Basic +', 'Unlimited stores', 'Custom domain', 'Advanced analytics', 'Remove branding', 'WhatsApp integration', 'Bulk upload (CSV)', 'API access'],
                cta: 'Start Free Trial', ctaStyle: 'pls-btn-primary'
              },
            ].map((plan, i) => (
              <div key={i} className={`pls-pricing-card${plan.popular ? ' pls-pricing-popular' : ''} pls-animate`}>
                ...
                <div className="pls-pricing-price">
                  ...
                  <div className="pls-pricing-period">{plan.period}</div>
                </div>
          ...
          <div className="pls-pricing-alternative pls-animate">
            <h4>Or Pay Per Transaction</h4>
            <p>KES 30 per verified order • No monthly commitment • Perfect for occasional sellers</p>
          </div>
        </div>
      </section>
